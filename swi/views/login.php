...
<body>
	...
	<div id="container" class="logincontainer">
		...
		<footer id="copyright">[ <a href="<?php print base_url(); ?>" target="_top"><img src=<?php print base_url(); ?>ico/world.png></a> ] &nbsp;&nbsp;&nbsp; Services Web Interface (SWI3) [<b><a href="<?php print site_url('main/credits'); ?>"><?php _t('gen_swicredits'); ?></a></b> ]</footer>
	</div>
